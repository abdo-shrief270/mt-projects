...
const DICT = {
    ...
    /* ---- home ---- */
    "home.hero.kicker": ["فريق هندسي وبرمجي", "Engineering & software team"],
    "home.hero.h1": ["من فكرة المشروع إلى نظام شغّال على الأرض", "From idea to a system that works on the ground"],
    "home.hero.lead": ["ننفّذ مشاريع التخرّج الإلكترونية، ونركّب أنظمة التيار الخفيف للمنازل والشركات، ونطوّر مواقع وتطبيقات فل-ستاك، ونقدّم كورسات عملية — بفريق واحد تتابع معه من البداية للتسليم.", "We build electronics graduation projects, install low-current systems for homes and businesses, develop full-stack web & mobile apps, and run hands-on courses — one team you follow from start to delivery."],
    "home.hero.cta1": ["تواصل معنا", "Contact us"],
    "home.hero.cta2": ["تعرّف على خدماتنا", "Explore our services"],
    "home.hero.tags": ["كاميرات ومراقبة · شبكات وداتا · إنذار حريق · <b>مواقع وتطبيقات</b> · مشاريع تخرّج · كورسات", "CCTV & security · Networks & data · Fire alarm · <b>Web & apps</b> · Graduation projects · Courses"],
    ...
    "home.services.h2": ["أربع خدمات تحت سقف واحد", "Four services under one roof"],
    "home.services.p": ["لا تحتاج للتنقّل بين أكثر من جهة — عندنا التنفيذ الهندسي والتركيب والبرمجة والتدريب في مكان واحد.", "No need to juggle multiple vendors — engineering, installation, software, and training in one place."],
    ...
    "ab.story.h2": ["بدأنا من مشروع تخرّج واحد", "We started with a single graduation project"],
    "ab.story.p1": ["أول ما بدأنا، كنا نساعد زملاءنا في مشاريع تخرّجهم — كود يشتغل، توصيلات مضبوطة، وشرح مفهوم. الكلام انتشر، وبدأ الطلب يكبر.", "When we started, we were helping classmates with their graduation projects — working code, correct wiring, and a clear explanation. Word spread, and demand grew."],
    "ab.story.p2": ["اليوم صار عندنا فريق يجمع بين الهندسة والبرمجة، ننفّذ من مشروع الطالب الصغير إلى نظام كاميرات وشبكة لشركة، إلى موقع أو تطبيق كامل. هدفنا بسيط: نسلّم شغلاً تفتخر به ويشتغل فعلاً.", "Today we're a team that blends engineering and software — from a student's small project to a company's camera & network system, to a full website or app. Our goal is simple: deliver work that works and that you're proud of."],
